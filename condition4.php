...
<head>
    ...
    margin: 0;
    padding: 0;
    background-image: url('des-5.jpg');
    background-size: 100%;
...
The main tourist activities on offer are sailing tours among icebergs, dog sledding tours, ice cap treks, wildlife spotting (including whale watching[2]), iceberg watching, and hiking trips to the mainly Norse ruins.</p>
            <h3>The Booking:</h3>
            <p>
        ...
        <div class="button">
        <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KbuEKvA6ZZ9oM6" async> </script> </form>
