...
<body class="main_bg">
   ...
   ?>
        ...
        <div class="main-form">
            <form action="connecting.php" method="post" onsubmit="required()">
                ...
                <div id="submit">
                    ...
                    <input type="submit" value="SUBMIT" id="submit" onclick="btn()">
                </div>
    ...
    <!-- <form class="button"><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_Kak2KNFNMbwdi1" async> </script> </form>  -->
        ...
        <!-- <script>
            function btn()
            {
                window.location.href="http://localhost/dev/tour%20and%20travel%20agency/condition.php"
            }
        </script> -->
